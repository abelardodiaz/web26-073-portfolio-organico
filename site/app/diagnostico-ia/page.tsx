...
import { ArtDiagnostico } from "@/components/shared/ServiceArt";
import { whatsappUrl, WHATSAPP_MSG_DIAGNOSTICO } from "@/lib/whatsapp";
...
const faqs = [
  {
    ...
    a: "No. El diagnostico esta pensado para duenos y gerentes de negocio. Tu me platicas como opera tu empresa y yo traduzco eso a oportunidades concretas, sin tecnicismos. La parte tecnica es mi trabajo.",
  },
  {
    q: "Que pasa con la informacion de mi negocio?",
    a: "Todo lo que platiquemos es confidencial y se usa unicamente para elaborar tu diagnostico. No comparto datos con terceros, y si tu empresa lo requiere, firmamos un acuerdo de confidencialidad antes de empezar.",
  },
  {
    q: "Cuanto tiempo toma?",
    a: "La entrevista dura entre 1 y 2 horas, presencial o remota. Despues analizo tus procesos y te entrego el reporte escrito con las oportunidades detectadas.",
  },
  {
    q: "Tengo que contratar algo mas despues?",
    a: "No. El diagnostico es sin compromiso de continuidad: el reporte es tuyo y puedes implementarlo con quien quieras. Si decides implementarlo conmigo, los $10,000 MXN se descuentan del costo del proyecto.",
  },
];

export default function DiagnosticoIAPage() {
  const waUrl = whatsappUrl(WHATSAPP_MSG_DIAGNOSTICO);
  ...
  return (
    <div className="relative">
      ...
      <div className="hidden editorial:block">
        ...
        <section className="relative mb-16">
          <div aria-hidden className="pointer-events-none absolute right-0 top-1/2 hidden -translate-y-1/2 text-primary/70 lg:block">
            <ArtDiagnostico className="size-48" />
          </div>
          ...
          <h1 className="mb-4 font-display text-3xl font-semibold tracking-tight sm:text-[2.75rem] sm:leading-[1.12]">
            ...
            que una maquina podria hacer{" "}
            <em className="text-primary">sola</em>
          </h1>
      ...
      <div className="hidden terminal:block">
        ...
        <section className="relative mb-14">
          <div aria-hidden className="pointer-events-none absolute right-0 top-1/2 hidden -translate-y-1/2 text-primary/55 lg:block">
            <ArtDiagnostico className="size-44" />
          </div>
      ...
      <StickyWhatsAppBar
        href={waUrl}
        price="$10,000 MXN"
        note={"Sin compromiso · 4 lugares por mes"}
        label="Agendar"
      />
      </div>
    </div>
