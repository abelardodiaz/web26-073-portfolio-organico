...
Acabo de publicar [claude-agent-patterns](/projects/claude-agent-patterns) con 8 patterns extraidos de un agente autonomo en produccion. Investigando el espacio, descubri que [OpenClaw](https://docs.openclaw.ai/) -- el framework de agente autonomo open source mas popular (6000+ stars) -- resuelve exactamente los mismos problemas fundamentales.
...
- [claude-agent-patterns](/projects/claude-agent-patterns) -- Los 8 patterns extraidos y documentados
