...
Primero, **resilencia gratis**. Reinicia el proceso, restartea APScheduler, recarga config: nada se pierde porque nada vivia en memoria que no estuviera tambien en BD.

Segundo, **operabilidad**. Para ver el estado del scheduler, queryeas `appointments` con cualquier client SQL. No hay que prender un dashboard especifico de APScheduler ni leer su jobstore.
