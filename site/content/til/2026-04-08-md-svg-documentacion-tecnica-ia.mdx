...
Asi se ve el codigo fuente de un documento Markdown:

<div style={{border: '1px solid var(--border)', borderRadius: 'var(--radius)', margin: '1.5em 0', overflow: 'hidden'}}>
<div style={{background: 'var(--muted)', padding: '0.5rem 1rem', borderBottom: '1px solid var(--border)', fontSize: '0.75rem', fontFamily: 'var(--font-mono)', color: 'var(--muted-foreground)'}}>carlota.md</div>
<div style={{padding: '1rem'}}>

```markdown
## Carlota de limon

Postre mexicano sin horno, listo en 20 min + refrigeracion.

### Ingredientes
- 2 paquetes de **galletas Maria**
- 1 lata de **leche condensada** (397g)
- 1 lata de **media crema** (225g)
- 1 taza de **jugo de limon** (~8 limones)
- Ralladura de 2 limones

### Pasos
1. Mezclar leche condensada + media crema + jugo de limon
2. Remojar galletas en jugo de limon diluido (2 segundos, no mas)
3. Capa de galletas, capa de mezcla, repetir 3 veces
4. Refrigerar **4 horas minimo** (mejor toda la noche)
5. Decorar con ralladura y galletas trituradas
```

</div>
</div>

Y asi se ve renderizado -- lo que leeria un humano (o una IA) al abrir el archivo:

<div style={{border: '1px solid var(--border)', borderRadius: 'var(--radius)', margin: '1.5em 0', overflow: 'hidden'}}>
<div style={{background: 'var(--muted)', padding: '0.5rem 1rem', borderBottom: '1px solid var(--border)', fontSize: '0.75rem', fontFamily: 'var(--font-mono)', color: 'var(--muted-foreground)'}}>Preview renderizado</div>
...
**Ingredientes:** 2 paquetes de **galletas Maria**, 1 lata de **leche condensada** (397g), 1 lata de **media crema** (225g), 1 taza de **jugo de limon** (~8 limones), ralladura de 2 limones.

**Pasos:** Mezclar leche condensada + media crema + jugo de limon. Remojar galletas 2 segundos. Alternar capas. Refrigerar **4 horas minimo**. Decorar con ralladura.

</div>
</div>

Markdown es texto plano que cualquier editor, celular o terminal puede abrir. No necesitas software especial. Git lo diffea linea por linea. Una IA lo parsea sin problema. Pero fijate que el proceso (mezclar, remojar, capas, refrigerar) es secuencial con bifurcaciones -- y eso es dificil de ver en una lista numerada.

### SVG: el mapa visual

Ahora el mismo proceso pero como diagrama. Primero el codigo fuente:

<div style={{border: '1px solid var(--border)', borderRadius: 'var(--radius)', margin: '1.5em 0', overflow: 'hidden'}}>
<div style={{background: 'var(--muted)', padding: '0.5rem 1rem', borderBottom: '1px solid var(--border)', fontSize: '0.75rem', fontFamily: 'var(--font-mono)', color: 'var(--muted-foreground)'}}>carlota_flujo.svg</div>
<div style={{padding: '1rem'}}>
...
<svg viewBox="0 0 600 320" xmlns="http://www.w3.org/2000/svg">
  ...
  <rect x="355" y="202" width="150" height="56" rx="8"
        fill="#E0F2FE" stroke="#0284C7" stroke-dasharray="6 3"/>
...
<svg viewBox="0 0 600 320" xmlns="http://www.w3.org/2000/svg" style={{maxWidth: '100%', height: 'auto'}}>
  <title>Flujo para preparar Carlota de limon</title>
  <desc>5 pasos desde ingredientes hasta postre listo</desc>
  <defs>
